  ...
  <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    ...
    function drawChart() {
    	...
    	data.addRows([
          		...
          		int count = 0;
          		//一時的に、温度を格納する配列
          		ArrayList<Integer> tival_hum= new ArrayList<Integer>();
          		...
          		try {
            		...
            		for(SampleData nig_da: nig_datas){
            			if(count == h_end + 6)
            				break;
						if(count >= h_end){%>
							['<%= nig_da.getDate() %>', <%=nig_da.getHum()%>, <%=tival_hum.get(count)%>],
						<%}
       			count++;
            		}
        		} finally {
...
<body>
	...
	<tr>
		...
		<th>
		<button class="button_nolink" type="submit" disabled="disabled">新潟</button>
		</a></th>
	...
	<tr>
		<div class="tabbox">
			<p class="tabs">
				<a href="Nigata_tmp.jsp" class="tab1" type="submit">温度</a>
